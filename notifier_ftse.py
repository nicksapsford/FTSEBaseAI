...
# LIVE_NOTIFICATIONS (.env, per-machine): True on K1 live only. Default False -> Dell paper SILENT for
# ALL trade notifications (brief Part 5). Hardware/process alerts are the System Monitor's, unaffected.
